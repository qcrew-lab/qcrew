...
filepath_list = "C:/Users/qcrew/Desktop/qcrew/data/cc2_deltaSQUID/20220309/190957_cc2_qubit_spec_current_sweep.h5"
freqs, currents_1, z_matrix_1 = read_results(filepath_list)

filepath_list = "C:/Users/qcrew/Desktop/qcrew/data/cc2_deltaSQUID/20220310/095520_cc2_qubit_spec_current_sweep.h5"

freqs, currents_2, z_matrix_2 = read_results(filepath_list)
currents = np.concatenate((np.array(currents_1), currents_2), axis=0)
z_matrix = np.concatenate((z_matrix_1, z_matrix_2), axis=0)

fig, ax = plt.subplots()
X, Y = np.meshgrid(*(currents, freqs))
ax.pcolormesh(X, Y, z_matrix.T, cmap="Blues")
