...
if __name__ == "__main__":
    ...
    with Stagehand() as stage:
        ...
        with DataSaver(db) as datasaver:
            ...
            ampx = stage.QUBIT.gaussian_pi.ampx
            stage.QUBIT.gaussian_pi.ampx = ampx*ampx_factor
            stage.QUBIT.gaussian_pi2.ampx = ampx*ampx_factor

            print("Changed gaussian_pi ampx to ", ampx*ampx_factor)
