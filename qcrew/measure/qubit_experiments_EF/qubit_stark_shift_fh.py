...
class StarkShift(Experiment):
    ...
    def __init__(self, qubit_pi, qubit_ef_pi, qubit_fh_op, fit_fn=None, **other_params):
    ...
    def QUA_play_pulse_sequence(self):
        ...
        """
        qubit, rr, qubit_drive, qubit_ef, qubit_fh = self.modes  # get the modes
        ...
        qua.update_frequency(qubit_fh.name, self.x)  # update qubit pulse frequency
        qubit_fh.play(self.qubit_fh_op)  # play qubit pi pulse
        qua.align()
...
if __name__ == "__main__":
    ...
    parameters = {
        "modes": ["QUBIT", "RR", "QUBIT_DRIVE", "QUBIT_EF", "QUBIT_FH"],
        "reps": 50000,
        "wait_time": 150000,
