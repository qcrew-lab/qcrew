...
class PhaseEstimation(Experiment):
    ...
    def QUA_play_pulse_sequence(self):
        ...
        qubit.play(self.qubit_grape, ampx=0.95)  # ampx = 0,
        cav.play(self.cav_grape, ampx=0.95)  # ampx = 0,
        ...
        qubit.play(self.qubit_grape_2, ampx=0.95)  # ampx = 0,
        cav.play(self.cav_grape_2, ampx=0.95)  # ampx = 0,
...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        "qubit_grape_2": "0+alpha2_700_to_vac",
        "cav_grape_2": "0+alpha2_700_to_vac",
        "single_shot": True,
        # "plot_quad": "I_AVG",
    }
