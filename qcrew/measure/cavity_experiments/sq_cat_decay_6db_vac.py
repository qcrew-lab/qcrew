...
class sq_cat_decay_6db_vac(Experiment):

    name = "sq_vcat_6db_vac"
    ...
    def QUA_play_pulse_sequence(self):
        ...
        Char_2D_singledisplacement(
            ...
            # tomo_phase=0.05 +0.00537 -0.02095,  # -0.20
        )
...
if __name__ == "__main__":
    ...
    tomo_phase = 0.05 + 0.00537 - 0.02095 + 0.01311 -0.00279
    ntimes = 10
    for k in range(ntimes):
        ...
        experiment = sq_cat_decay_6db_vac(**parameters)
