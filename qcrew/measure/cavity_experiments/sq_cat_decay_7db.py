...
class sq_cat_decay_7db(Experiment):
...
if __name__ == "__main__":
    ...
    for k in range(ntimes):
        for n in range(len(decay_sweep)):
            ...
            # 7.1dB=  (-0.845,  0.613),  (2.6368,  0.30), (-0.91, -0.80)
            # V_cat amp = 0.7948

            u1_amp_scale = -0.845
            v1_amp_scale = 0.613

            u2_amp_scale = 1.3184  # 2.6368/2
            v2_amp_scale = 0.30

            u3_amp_scale = -0.91
            v3_amp_scale = -0.80

            u_cat_amp_scale = 0.5298  # 0.7948*2/3
            ...
            experiment = sq_cat_decay_7db(**parameters)
