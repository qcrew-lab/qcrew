...
class sq_cat_decay_6db_vac_1d(Experiment):

    name = "sq_vcat_6db_vac_1d"
...
if __name__ == "__main__":
    ...
    tomo_phase_list = [
        0.05 + 0.25 - 0.002
    ]  # [-0.1576622 , -0.27687011, -0.3487406 , -0.19829992, -0.05650155,-0.193049  , -0.39657031, -0.2469115 , -0.09854887]

    decay_sweep = [16]  # [1e3, 10e3, 20e3, 35e3, 50e3, 70e3, 100e3, 150e3, 200e3]
    ...
    for n in range(5):
        for k in range(len(decay_sweep)):
            ...
            experiment = sq_cat_decay_6db_vac_1d(**parameters)
