...
class T2(Experiment):
    ...
    def __init__(
        self, qubit_op, fit_fn, rr_drive, detuning=0, **other_params
    ):
    ...
    def QUA_play_pulse_sequence(self):
        ...
        rr.play(self.rr_drive, duration=self.y, ampx=0.4)
...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        "y_sweep":np.linspace(10, 200, 20, dtype = 'int').tolist() + np.linspace(220, 600, 20, dtype = 'int').tolist(),
