...
from qcrew.measure.cavity_experiments.normal_cat_decay import normal_cat_decay
...
if __name__ == "__main__":
    ...
    # decay_sweep = [1000, 10000, 50000, 100000, 150000, 200000]
    ...
    for k in range(ntimes):
        for n in range(len(decay_sweep)):
            ...
            normal_experiment = normal_cat_decay(**noraml_parameter)
