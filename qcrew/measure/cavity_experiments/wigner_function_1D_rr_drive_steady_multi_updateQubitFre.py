...
class WignerFunction(Experiment):
    ...
    def __init__(
        self, cav_op, qubit_op, rr_drive, drive_amp, qubitfre, fit_fn="gaussian", delay=4, **other_params
    ):
        self.cav_op = cav_op
    ...
    def QUA_play_pulse_sequence(self):
        ...
        rr.play(
            self.rr_drive, duration=int(380 + 52 + 32 + self.delay // 4), ampx=self.drive_amp
        )
        qua.wait(int(380))
...
if __name__ == "__main__":
    drive_amp_list = [0.0, 0.0125, 0.025, 0.0375, 0.05, 0.0625, 0.075, 0.0875, 0.1, 0.1125, 0.125, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8]
    qubitfre_list = np.array([-60.0, -60.0, -60.0, -59.95, -60.0, -59.95, -60.1, -60.05, -60.1, -60.1, -60.0, -60.05, -60.15, -60.1, -60.25, -60.55, -60.65, -60.8, -61.1, -61.3, -61.75, -61.5, -62.1, -62.3, -63.0])*1e6
    ...
    for i in range(len(drive_amp_list)):
        ...
        parameters = {
            ...
            # "y_sweep": np.round(np.linspace(0, 0.125, 11), 4).tolist()
            # + np.round(np.linspace(0.15, 0.8, 14), 4).tolist(),
        ...
        experiment.name = "wigner_function_rrdrive_steady_No{}_ampx0.1times{}_QubitFre{}_".format(i, drive_amp, qubitfre/1e6)
