...
class char_func_1D_preselect_lk_coh(Experiment):

    name = "char_func_1D_preselect_lk_coh"
    ...
    def QUA_play_pulse_sequence(self):
        ...
        if 1:  # low chi evolution
            ...
            cav.play("cohstate_2dot5_short_lk", ampx=1)
...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        "delay": 112,  # wait time between opposite sign displacements
    ...
    experiment = char_func_1D_preselect_lk_coh(**parameters)
