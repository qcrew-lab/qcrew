...
class Parametrized(MutableMapping):
    def __init__(self, *args, **kwargs):
        ...
        for item in args: 
            if isinstance(item, str):
                ...
                raise ValueError("The arguments given in *args have wrong format. Correct argument format:[str] or ([str], [other type])")
    ...
    def __repr__(self):
        return yaml.dump(self._parameter, sort_keys=False)
...
if __name__ == "__main__":
    test = Parametrized("key1", "key2",("name", "test_name"), ( "length", 21), arg3=3,arg4=4)
    print(test)
