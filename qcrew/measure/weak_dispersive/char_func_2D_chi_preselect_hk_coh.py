...
class char_func_2D_chi_preselect_hk_coh(Experiment):

    name = "char_func_2D_chi_preselect_hk_coh"
...
if __name__ == "__main__":
    ...
    experiment = char_func_2D_chi_preselect_hk_coh(**parameters)
