...
class PowerRabi(Experiment):
    ...
    def QUA_play_pulse_sequence(self):
        ...
        qua.align()
        qua.play("constcos80ns_tomo_RO_tomo_E2pF2pG2pH2" * qua.amp(0.0524), "FLUX")

        qua.wait(int(50 // 4), rr.name, "QUBIT_EF")  # wait system reset
        ...
        qua.wait(int(800 // 4), rr.name, "QUBIT_EF")  # wait system reset
        qua.play("digital_pulse", "QUBIT_EF")
        rr.measure((self.I, self.Q), ampx=0)  # measure qubit state
