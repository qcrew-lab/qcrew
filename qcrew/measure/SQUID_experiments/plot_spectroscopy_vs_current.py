...
filepath_list = "C:/Users/qcrew/Desktop/qcrew/data/cc1_nu/20230125/170456_cc1_nu_qubit_spec_current_sweep.h5"
freqs, currents_1, z_matrix_1 = read_results(filepath_list)
print(z_matrix_1.shape)
# plt.plot(z_matrix_1[0, 100:300])
# plt.plot(z_matrix_1[1, 100:300])
# plt.show()
...
fig, ax = plt.subplots()
ax.pcolormesh(list(currents_1), freqs, -z_matrix_1.T, cmap="Blues")
