...
class sq_cat_decay_6db_oddcat_1d(Experiment):

    name = "sq_vcat_6db_oddcat_1d"
...
if __name__ == "__main__":
    ...
    tomo_phase_list = [
        ...
        # -0.13887576 - 0.142687 + 0.00908 + 0.00908 -0.01219892+0.004 ,
        # -0.08391143 - 0.26373 + 0.00686 + 0.00686 - 0.01244935 - 0.0083,
        # -0.21217849 + 0.0086455 + 0.0025 + 0.0025 - 0.01,
        # -0.07661771 + 0.00296 + 0.007836 + 0.007836 - 0.0082,
        # -0.21118821 + 0.00469 + 0.00862 + 0.00862 - 0.01520052 - 0.01,
        # -0.16405136 - 0.27336 + 0.01958 + 0.01958 - 0.01682689 - 0.01,
        # -0.1608981 - 0.14113832 + 0.0317 + 0.0317 - 0.03137782 - 0.0292,
        -0.16764681
        + 0.02339
        + 0.02339
        - 0.01212014
    ...
    for n in range(10):
        for k in range(len(decay_sweep)):
            ...
            experiment = sq_cat_decay_6db_oddcat_1d(**parameters)
