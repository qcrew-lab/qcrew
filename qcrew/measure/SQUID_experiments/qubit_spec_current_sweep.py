...
if __name__ == "__main__":
    ...
    with Stagehand() as stage:
        ...
        yoko = stage.YOKO
        yoko.source = "current"  # set output to nominal value
        yoko.state = True
        ...
        with DataSaver(db) as datasaver:
            ...
            for current in current_sweep:
                ...
                yoko.ramp(current, start=yoko.level, step=0.01e-3)  #  in ampere
            ...
            yoko = stage.YOKO
            yoko.ramp(0e-3, start=yoko.level, step=0.01e-3)  #  in ampere
            yoko.state = False
