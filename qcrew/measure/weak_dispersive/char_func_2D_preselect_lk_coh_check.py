...
class char_func_2D_preselect_lk_coh(Experiment):

    name = "char_func_2D_preselect_lk_coh"
    ...
    def QUA_play_pulse_sequence(self):
        ...
        if 1:  # low chi evolution
            ...
            qua.update_frequency(cav.name, int(-39.251e6), keep_phase=True)
...
if __name__ == "__main__":
    ...
    experiment = char_func_2D_preselect_lk_coh(**parameters)
