"""
A python class describing a Ramsey Photon Experiment using QM.
...
class Photon_Ramsey(Experiment):
...
if __name__ == "__main__":
    ...
    for k in range(n_times):
        ...
        experiment = Photon_Ramsey(**parameters)
        experiment.setup_plot(**plot_parameters)

        prof.run(experiment)
        time.sleep(0)  # sec 5min = 300
