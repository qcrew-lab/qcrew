...
class CharacteristicFunction1Dff(Experiment):

    name = "char_func_1D_qua_macro_no_switch_ff"
    #with fast flux and measure only real or imag
    ...
    def QUA_play_pulse_sequence(self):
        ...
        qua.wait(int(1450 // 4), rr.name, "QUBIT_EF")  # ns
...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        "delay": 100,  # 188,  # wait time between opposite sign displacements
    ...
    experiment = CharacteristicFunction1Dff(**parameters)
