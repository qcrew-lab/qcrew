...
class T2(Experiment):
    ...
    def __init__(self, qubit_op, fit_fn, rr_drive, detuning=0, **other_params):
    ...
    def QUA_play_pulse_sequence(self):
        ...
        rr.play(self.rr_drive, duration=int(380), ampx=1)
...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        "y_sweep": np.linspace(10, 1000, 25, dtype = 'int').tolist(),
