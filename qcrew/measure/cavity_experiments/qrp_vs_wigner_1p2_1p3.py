...
class NumberSplitting3point(Experiment):
    ...
    def __init__(self, qubit_op_measure, cav_op, qubit_op, fit_fn=None, **other_params):
        ...
        self.probing_list = [
            ...
            # ("qctrl_fock_1pi2", (0.38225617, -0.99489863)),
            # ("qctrl_fock_1pi2", (-1.11579993, -0.00203959)),
            # ("qctrl_fock_1pi2", (0.61395454, 0.72252121)),
            # ("qctrl_fock_1pi2", (1.03740582, 0.96512163)),
            # ("qctrl_fock_1pi2", (0.81294727, -0.01561215)),
            # ("qctrl_fock_1pi2", (0.09494793, 0.88061383)),
            # ("qctrl_fock_1pi2", (-0.35772628, 1.17679072)),
            # ("qctrl_fock_1pi2", (0.49695525, 0.16147493)),
            # ("qctrl_fock_1pi2", (-0.32299587, 0.44293726)),
            # ("qctrl_fock_1pi2", (-0.72274272, 0.51109849)),
            # ("qctrl_fock_1pi2", (-0.16474317, -0.56787676)),
            # ("qctrl_fock_1pi2", (-0.97859858, -0.45892448)),
            # ("qctrl_fock_1pi2", (-0.42746846, -1.05407622)),
            # ("qctrl_fock_1pi2", (0.51310245, -0.8432099)),
            # ("qctrl_fock_1pi2", (1.2550222, -0.17791612)),
