...
class CharacteristicFunction2D(Experiment):
    ...
    def QUA_play_pulse_sequence(self):
        ...
        # Vacuum "preparation" -> cohstate amplitude is zero
        ...
        # Evolution
        qua.wait(1250, cav.name)
        qua.align()
        qua.wait(22, flux.name, rr.name, qubit.name, "QUBIT_EF")
        ...
        Char_2D_singledisplacement(
            ...
            delay=self.delay,
            measure_real=True,
            tomo_phase=-0.91662,  # 0.0372- 0.2312 - 0.2107,
            correction_phase=-0.0105,
        )

        # Measure qubit state
        qua.wait(int(1100 // 4), rr.name, "QUBIT_EF")
        ...
        ##################################################################
        #################### Real Characteristic for alpha1 ##############
        ##################################################################
        ...
        ##################################################################
        #################### Real Characteristic for alpha2 ##############
        ##################################################################
        ...
        ##################################################################
        #################### Real Characteristic for alpha3 ##############
        ##################################################################
        ...
        ##################################################################
        #################### Real Characteristic for alpha4 ##############
        ##################################################################
