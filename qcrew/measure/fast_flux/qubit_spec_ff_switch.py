...
class QubitSpectroscopyFastFlux(Experiment):
    ...
    def QUA_play_pulse_sequence(self):
        ...
        flux.play("constcos20ns_tomo_RO_tomo_new_E2pF2pG2pH2_2", ampx=-0.571) #-0.5625
        with qua.switch_(self.y):
            with qua.case_(0):
                qua.wait(42, qubit.name)
...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        # "y_sweep": [-0.31],
        "y_sweep": (0, 1, 2),
        "qubit_op": "gaussian_pi_80",  # constant_pi_short gaussian_pi_80
        "qubit_delay": 200,  # ns
        "rr_delay": 1500, #800,  # ns
