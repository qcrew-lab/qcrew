...
if __name__ == "__main__":
    ...
    flux_len_list = np.arange(4, 100, 4)
        ...
        for flux_len in flux_len_list:
            flux.operations = {
                f"castle_IIR_230727_{flux_len}": NumericalPulse(
                    path=f"C:/Users/qcrew/Desktop/qcrew/qcrew/config/fast_flux_pulse/castle_IIR_2/castle_IIR_230727_{flux_len}ns_0dot10_2250.npz",
                    I_quad="I_quad",
                    Q_quad="Q_quad",
                    ampx=1,
                ),
