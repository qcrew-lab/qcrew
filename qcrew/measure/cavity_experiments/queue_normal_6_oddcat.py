...
from qcrew.measure.cavity_experiments.sq_cat_decay_6db_oddcat import sq_cat_decay_6db_oddcat
from qcrew.measure.cavity_experiments.normal_cat_decay_loop_oddcat import normal_cat_decay_loop_oddcat
    ...
    for k in range(ntimes):
        for n in range(len(decay_sweep)):
            noraml_parameter = {
                ...
                "v3_amp_scale": 0,
                "ecd_amp_scale": 0,
                "u_cat_amp_scale": 1.2,  # alpha = 1.8 *2 / ECD 3 = 1.2
            ...
            normal_experiment = normal_cat_decay_loop_oddcat(**noraml_parameter)
            normal_experiment.setup_plot(**plot_parameters)

            prof.run(normal_experiment)

            time.sleep(20)

            sq_6db_experiment = sq_cat_decay_6db_oddcat(**sq_6db_parameter)
