...
class normal_cat_decay_oddcat(Experiment):

    name = "normal_cat_decay_loop"
...
if __name__ == "__main__":
    ...
    # tomo_phase_list = [
    #     -0.42325098 + 0.25 + 0.00687,
    #     -0.03799802 + 0.25 + 0.007059,
    #     -0.10773067 + 0.25 + 0.00417,
    #     -0.20976808,
    #     -0.11199418 + 0.0381,
    #     -0.21153676 - 0.0060,
    #     -0.16345656 + 0.22385,
    #     -0.18235406 + 0.12910591836102794 + 0.2540709,
    #     -0.36583726 - 0.0539 + 0.251496,
    # ]
    tomo_phase_list = [
        -0.11199418 + 0.0381+ 0.015-0.0076,
        -0.16345656 + 0.22385 - 0.00333 +0.0166,
    ]
    decay_sweep = [
        50e3,
        100e3,
    ...
    #     for k in range(10):
            ...
            experiment = normal_cat_decay_oddcat(**parameters)
