...
class sq_cat_decay_3db_oddcat_1d(Experiment):

    name = "sq_vcat_3db_oddcat_1d"
    ...
    def QUA_play_pulse_sequence(self):
        ...
        qua.align()
        cav.play("constant_cos_cohstate_1", ampx=-0.065, phase=0.25)
...
if __name__ == "__main__":
    ...
    for n in range(10):
        ...
        v_cat_amp_scale = 0.8495  # # 1.2743*2/3

        decay_time = decay_sweep
        ...
        experiment = sq_cat_decay_3db_oddcat_1d(**parameters)
